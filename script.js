const challenges = [
  ...
  },
  {
    ...
    challenge: "1-Beginner/Cause-Effect-App.md",
  },
];
...
const createTable = () => {
  ...
  for (let count = 0; count < challenges.length; count++) {
    content +=
      "<tr>\n" +
      "<td><a href='./" +
      challenges[count].name +
      "/'>" +
      challenges[count].name +
      "</a></td>\n" +
      "<td>" +
      challenges[count].description +
      "</td>\n" +
      "<td><a href='https://github.com/gabrielsanva/app-ideas/blob/master/Projects/" +
      challenges[count].challenge +
      "'>Challenge</a></td>\n" +
      "<td><a href='https://github.com/gabrielsanva/app-ideas-my-resolutions/tree/main/" +
      challenges[count].name +
      "'>GitHub</a></td>\n" +
      "</tr>";
    ...
    contentMD +=
      ...
      challenges[count].description +
      "|" +
      "[Original Challenge](https://github.com/gabrielsanva/app-ideas/blob/master/Projects/" +
      challenges[count].challenge +
      ")\n";
  }
